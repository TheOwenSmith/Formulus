import { Action, ALGORITHM_MAX_HOLDING_PROPORTION_LIMIT } from '@api/core/algorithms/algorithm';
import {
  indicatorSchema,
...
import { tickerSchema, timestampSchema, type Bar, type Ticker } from '@api/fetch/types';
import z from 'zod';
