      ...
      >
        ...
        <div className="flex gap-2 mt-auto pt-1">
          ...
          <div
            className="flex-1"
            onMouseEnter={() => {
              isOverRunButtonRef.current = true;
            }}
            onMouseLeave={() => {
              isOverRunButtonRef.current = false;
            }}
          >
...
export function AlgorithmsPage() {
  ...
  const backtestLimitTooltip = isAtConcurrentLimit
    ...
    : isAtMonthlyLimit
      ? `Monthly backtest limit reached (${monthlyCount}/${monthlyLimit}).${isPro ? '' : ' Upgrade to Pro for 100/month.'}`
      : undefined;
